...
export const NowPlayingScreen: React.FC<NowPlayingScreenProps> = ({
    track, isPlaying, isLoading, progress, currentTime, duration,
    isShuffled, repeatMode, isLiked,
    onToggleShuffle, onToggleRepeat, onToggleLike, onSeek,
    volume = 1, queueIndex = 0, queueLength = 1,
}) => {
    ...
    const btn: React.CSSProperties = {
        ...
        padding: 0, margin: 0, transition: 'color 0.15s',
    };
        ...
        <div style={{
            ...
            {volShow && (
                <div style={{
                    ...
                    minWidth: 150, backdropFilter: 'blur(12px)',
                }}>
                    ...
                    <div style={{ flex: 1, height: 4, background: 'rgba(255,255,255,0.2)', borderRadius: 2 }}>
                        <div style={{
                            ...
                            background: '#fff', borderRadius: 2, transition: 'width 0.1s',
                        }} />
                    </div>
                    <span style={{ fontSize: 9, color: '#8e8e93', fontFamily: F, minWidth: 24, textAlign: 'right' }}>
            ...
            <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1, flexShrink: 0, marginTop: 12 }}>
                    <div style={{
                        ...
                        <img 
                            ...
                            alt={track.title}
                            style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', transform: 'scale(1.0)' }}
                            onError={(e) => {
                ...
                <div style={{
                    ...
                    textAlign: 'center', flexShrink: 0, marginTop: 12,
                    padding: `0 ${px}px`,
                }}>
                    <div style={{
                ...
                <div style={{
                    ...
                    <div
                        ...
                        style={{
                            ...
                            height: 22, cursor: 'pointer', touchAction: 'none',
                        }}
                    >
                        {/* Track background */}
                        <div style={{
                        ...
                        {/* Knob */}
                        <div style={{
                            position: 'absolute', left: pct, top: 11.5,
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                            ...
                            <button onClick={onToggleRepeat}
                                style={{ ...btn, color: repeatMode !== 'off' ? '#0a84ff' : '#8e8e93', width: 26, height: 26, position: 'relative' }}>
                                <Repeat size={16} strokeWidth={2.5} />
                                {repeatMode === 'one' && (
                                    <span style={{
                                        position: 'absolute', top: '50%', left: '50%',
                                        transform: 'translate(-50%, -50%)',
                                        fontSize: 7, fontWeight: 800, color: '#0a84ff',
                                    }}>1</span>
                                )}
                            </button>
                        </div>
